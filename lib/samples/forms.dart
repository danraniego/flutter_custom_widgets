...
//                                     '     ${fieldType == DInputType.phone ? 'options: ${getOptions()}':'' }\n'
//                                     ')',
//                                     child: DInputField(
//                                         controller: controller,
//                                         labelText: "Enter ${fieldType.label}",
...
//                                         DListTileCheckBox(
//                                             title: "Required",
//                                             value: [DInputType.search].contains(fieldType) ? false : required,
//                                             enabled: ![DInputType.search].contains(fieldType),
...
//                                             enabled: [DInputType.phone, DInputType.search].contains(fieldType) == false,
//                                             onChanged: (bool? value) {
//                                               setLeftIcon(value);
//                                             }
//                                         ),
